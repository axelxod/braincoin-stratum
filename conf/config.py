...
CENTRAL_WALLET = 'Xjwvo8WcEZw2nKV5m2dY6QTexWZR2j1M5L'                # Local coin address where money goes

COINDAEMON_TRUSTED_HOST = 'localhost'
COINDAEMON_TRUSTED_PORT = 6389
COINDAEMON_TRUSTED_USER = 'luciferdark'
COINDAEMON_TRUSTED_PASSWORD = 'fkbcfghbcdtndctv'                        
ALGORITHM = 5
